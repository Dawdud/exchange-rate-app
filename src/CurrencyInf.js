export class CurrencyData {
  ...
  getCurrencyValue() {
    ...
    const lastCurrency = Object.keys(this.currencyInformation).length - 1;
  ...
  getUrl() {
    for (let key in this.currencyTableObjects) {
      if (this.currencyTableObjects[key]["name"] === this.selectedOptionValue) {
        this.currnecyValues = {
